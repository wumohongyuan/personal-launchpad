...
将仓库中的 `.obsidian/plugins/personal-launchpad/` 文件夹复制到你的 Vault 同路径，再在 Obsidian 的「设置 → 第三方插件」中启用 **Personal Launchpad**。随后点击左侧功能区的仪表盘图标，或运行命令 `Open personal launchpad`。
